		...
		<div className="container">
			...
			<section className="flex-container about">
				...
				<div className="about-text">
					...
					<p>Like anyone, my bacon-bringing profession doesn’t describe a singular skill set. I possess some handy dandy administrative skills and I’ve achieved guru status in customer service. In a pinch, I’ve been known to dazzle a client with marketing copy.</p>
			...
			<a 
				...
				id="peacock" 
			>
				The Peacock (description)
			</a>
			<h1>The Peacock</h1>

			<section className="flex-container about">
				<img 
					alt="The Peacock illustration"
					src={peacock} 
					className="peacock"
				/>
				<div>
