	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-7 col-xl-7 col-lg-offset-1 col-xl-offset-1">
				<p class="lead marginTop20">For a school project, I put together a new concept for Good Housekeeping magazine including a refresh of the masthead, color scheme and typography.<a class="see_project" href="{{ action('PortfolioController@goodHousekeeping') }}" alt="Good Housekeeping Magazine Redesign Project">&nbsp;&nbsp;see project</a></p>
				<hr>
